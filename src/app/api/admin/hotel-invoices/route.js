...
export async function POST(request) {
  try {
    ...
    // Stamp agent_user_id always; for agents also override identity from session
    // so the "Generated by" line always carries the agent name + number.
    ...
    if (role === 2) {
      ...
      if (agentUser) {
        ...
        body.agent_no    = agentUser.custom_id || body.agent_no || '';
        body.agent_phone = agentUser.phone || body.agent_phone || '';
      }
    }
