...
const defaultData = {
  title: '', slug: '', content: '', galleries: [], is_featured: false,
...
export default function AdminDestinationCreatePage() {
  return <AdminFormPage title="Destination" apiUrl="/api/admin/destinations" backUrl="/admin/destinations" defaultData={defaultData}>{DestinationFormFields}</AdminFormPage>;
}
